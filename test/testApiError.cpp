...
TEST_F(ApiTestError, ImproperKeyInnerNode)
{
    ...
    ASSERT_FALSE(result);
    ASSERT_EQ(api.getLastErrorCode(), ErrorCode::API_NOT_KEY_IN_MAP);
}
...
TEST_F(ApiTestError, OutOfIndexInnerNode)
{
    ...
    ASSERT_FALSE(result);
    ASSERT_EQ(api.getLastErrorCode(), ErrorCode::API_INDEX_OUT_OF_ARRAY);
}
...
TEST_F(ApiTestError, inconsistentDataInnerNode)
{
    ...
    ASSERT_FALSE(result);
    ASSERT_EQ(api.getLastErrorCode(), ErrorCode::API_INCONSISTENT_DATA);
}
...
TEST_F(ApiTestError, inconsistentDataOuterNode)
{
    ...
    ASSERT_FALSE(result);
    ASSERT_EQ(api.getLastErrorCode(), ErrorCode::API_NODE_NOT_ARRAY);
}
...
TEST_F(ApiTestError, emptyApi_1)
{
    ...
    ASSERT_FALSE(result);
    ASSERT_EQ(api.getLastErrorCode(), ErrorCode::API_EMPTY);
}

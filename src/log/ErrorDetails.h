...
static const std::unordered_map<ErrorCode, std::optional<std::string>> ErrorDetails = 
{
    ...
    { ErrorCode::MANAGER_ROOT_NOT_NULL,
    ...
    { ErrorCode::JSON_VALIDATOR_BRACKET_SQUARE,      std::nullopt },
    { ErrorCode::JSON_VALIDATOR_IMPROPER_BEGIN,      std::nullopt },
    { ErrorCode::JSON_VALIDATOR_IMPROPER_END,        std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_COMMA,         std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_COLON,         std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_CURLY_CLOSE,   std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_CURLY_OPEN,    std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_BOOL,          std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_DOUBLE,        std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_INT,           std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_SQUARE_CLOSE,  std::nullopt },
    { ErrorCode::JSON_VALIDATOR_AFTER_SQUARE_OPEN,   std::nullopt },

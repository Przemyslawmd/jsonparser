...
static const std::unordered_map<ErrorCode, std::optional<std::string>> ErrorDetails = 
{
    ...
    { ErrorCode::VALIDATOR_AFTER_COMMA,              std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_COLON,              std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_CURLY_CLOSE,        std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_CURLY_OPEN,         std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_BOOL,               std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_DOUBLE,             std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_INT,                std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_SQUARE_CLOSE,       std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_SQUARE_OPEN,        std::nullopt },
    { ErrorCode::VALIDATOR_AFTER_STRING,             std::nullopt },
};
